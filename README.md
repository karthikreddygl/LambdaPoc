...
This is a sample template for LambdaPoc - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name lambdapoc --tail
```
...
```bash
aws cloudformation delete-stack --stack-name lambdapoc
```
